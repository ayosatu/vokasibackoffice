...
class commandrun extends CI_Model
{
    public function listcommanduser($chatid){
        $message = "" ;
        $o_msg =""; 
        try{
    ...
    public function requestlistchannel($chatid){
        $message = "" ;
        $o_msg =""; 
        try{
            /*Open Connection*/
    ...
    /*function ldap*/
    public function ldapconnection($_user_id, $_user_pwd){
    ...
    /*Run custom Command*/
    public function customcommand($chatid, $messageid, $text){
        $message = "" ;
        $o_msg =""; 
        try{
            /*Open Connection*/
    ...
    public function chekjobstatus($cmd){
        $message = "" ;
        $o_msg =""; 
        try{
            /*Open Connection*/
    ...
    public function registermpro($chatid,$text){
        $message = "" ;
        $o_msg =""; 
        try{
            /*Open Connection*/
