...
<body class="theme-red">
    ...
    <!-- Top Bar -->
    <nav class="navbar">
        <div class="container-fluid" action="<?= base_url('instansi')?>" >
            ...
            <div class="menu">
                <ul class="list">
                    ...
                    <li>
                        ...
                        <ul class="ml-menu">
                        <li>
                                <a href="<?= base_url('asset/');?>pages/ui/alerts.html">Users </a>
                            </li>
                            <li>
                                <a href="<?= base_url('asset/');?>pages/ui/animations.html">Module</a>
                            </li>
                            <li>
                                <a href="<?= base_url('asset/');?>pages/ui/animations.html">Role </a>
                            </li>

                            <li>
                                <a href="<?= base_url('asset/');?>pages/ui/animations.html">User Role </a>
                            </li>

                            <li>
                                <a href="<?= base_url('asset/');?>pages/ui/animations.html">Icons  </a>
                            </li>

                            <li>
                                <a href="<?= base_url('asset/');?>pages/ui/animations.html">Menu </a>
                            </li>
                    ...
                    <li>
                        ...
                        <ul class="ml-menu">
                            <li>
                                <a href="<?= base_url('asset/');?>pages/ui/alerts.html">References</a>
                            </li>
                            <li>
                                <a href="<?= base_url('asset/');?>pages/ui/animations.html">Global Param</a>
                            </li>
                            <li>
                                <a href="<?= base_url('asset/');?>pages/ui/animations.html">School Years</a>
                            </li>
                        ...
                        <a href="javascript:void(0);" class="menu-toggle">
                         ...
                         <ul class="ml-menu">
                            ...
                            <li>
                                    ...
                                    <ul class="ml-menu">
                                    <li>
                                        <a href="<?= base_url('asset/');?>pages/forms/advanced-form-elements.html">Majors</a>
                                    </li>
                                    <li>
                                        <a href="<?= base_url('asset/');?>pages/forms/form-examples.html">Employee</a>
                                    </li>
                                    <li>
                                        <a href="<?= base_url('asset/');?>pages/forms/form-validation.html">Students</a>
                                    </li>
                                    <li>
                                        <a href="<?= base_url('asset/');?>pages/forms/form-wizard.html" >Parents</a>
                                    </li>
                            ...
                            <li>
                                    ...
                                    <ul class="ml-menu">
                                        <li>
                                            <a href="<?= base_url('asset/');?>pages/ui/alerts.html">Channels</a>
                                        </li>
                                        <li>
                                            <a href="<?= base_url('asset/');?>pages/ui/animations.html">Commands</a>
                                        </li>
                                        <li>
                                            <a href="<?= base_url('asset/');?>pages/ui/animations.html">Broadcast (Schedule)</a>
                                        </li>
                                        <li>
                                            <a href="<?= base_url('asset/');?>pages/ui/animations.html">User Role</a>
                                        </li>
